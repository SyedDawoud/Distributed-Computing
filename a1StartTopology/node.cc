...
void node::initialize() {
    this->neightbour_out["A"] = "out";
    if (strcmp("B", getName()) == 0) {
        content_list.push_back("file-a");
        content_list.push_back("file-b");
        content_list.push_back("file-c");
        content_list.push_back("file-d");
        content_list.push_back("file-e");
        content_list.push_back("file-f");
        content_list.push_back("file-g");
        content_list.push_back("file-h");
        content_list.push_back("file-i");
        content_list.push_back("file15");
        ...
        content_list.push_back("file12");
        content_list.push_back("file13");
        content_list.push_back("file14");
        content_list.push_back("file16");
        content_list.push_back("file15");

    } else if (strcmp("D", getName()) == 0) {
        content_list.push_back("file-a");
        content_list.push_back("file-b");
        content_list.push_back("file-c");
        content_list.push_back("file-d");
        ...
        content_list.push_back("file17");
        content_list.push_back("file18");
        ...
        q->setOrigin("E");
        q->setLocation_found(false);
        q->setQueriedData("file6");
        id_source[q->getSeq_id()] = getName();
        this->broadcastMessage(q, getName());

    } else if (strcmp("F", getName()) == 0) {
        content_list.push_back("file1");
        content_list.push_back("file2");
        content_list.push_back("file3");
        content_list.push_back("file-a");
    ...
    } else if (strcmp("G", getName()) == 0) {
        content_list.push_back("file21");
        content_list.push_back("file22");
        content_list.push_back("file23");
        ...
        content_list.push_back("file15");
        content_list.push_back("file16");
        content_list.push_back("file25");

    } else if (strcmp("H", getName()) == 0) {
        content_list.push_back("file-a");
        content_list.push_back("file-b");
        content_list.push_back("file-c");
        content_list.push_back("file5");
        ...
        content_list.push_back("file25");
        content_list.push_back("file26");
        content_list.push_back("file27");
        content_list.push_back("file15");
    } else if (strcmp("I", getName()) == 0) {
        content_list.push_back("file-a");
        content_list.push_back("file-b");
        content_list.push_back("file-c");
        content_list.push_back("file-d");
...
void node::sendBack(query *q, const char* destination) {
...
void node::broadcastMessage(query *q, const char* src) {
...
bool node::checkForFile(const char *check) {
